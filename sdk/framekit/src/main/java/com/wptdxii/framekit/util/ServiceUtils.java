...
public final class ServiceUtils {
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(Extension.getExtension().getApplication(), cls);
        Extension.getExtension().getApplication().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(Extension.getExtension().getApplication(), cls);
        return Extension.getExtension().getApplication().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(Extension.getExtension().getApplication(), cls);
        Extension.getExtension().getApplication().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        Extension.getExtension().getApplication().unbindService(conn);
    }
