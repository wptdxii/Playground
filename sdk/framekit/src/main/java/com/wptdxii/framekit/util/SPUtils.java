...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = Extension.getExtension().getApplication().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = Extension.getExtension().getApplication().getSharedPreferences(spName, mode);
    }
     ...
     * or {@code CollectionUtils.<String>emptySet()} otherwise
     */
