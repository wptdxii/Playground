...
public final class ProcessUtils {
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(application.getPackageName(), 0);
                AppOpsManager aom =
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) application.getSystemService(Context.USAGE_STATS_SERVICE);
    ...
    public static boolean isMainProcess() {
        return Extension.getExtension().getApplication().getPackageName().equals(getCurrentProcessName());
    }
    ...
    public static String getCurrentProcessName() {
        ActivityManager am = (ActivityManager) Extension.getExtension().getApplication().getSystemService(Context.ACTIVITY_SERVICE);
        if (am == null) return null;
        List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
